 ...
 * @since 3.2
 */
public class MyDbScan<T extends Clusterable> extends Clusterer<T> {
     ...
     */
    public MyDbScan(final double eps, final int minPts)
     ...
     * @throws NotPositiveException if {@code eps < 0.0} or {@code minPts < 0}
     */
    public MyDbScan(final double eps, final int minPts, final DistanceMeasure measure)
        throws NotPositiveException {
        super(measure);
